...
public class TrollyTest {
    ...
    @Rule
    public ActivityTestRule<Trolly> mActivityTestRule = new ActivityTestRule<>(Trolly.class);

    @Test
    public void trollyTest() {
        ...
        ViewInteraction autoCompleteTextView2 = onView(
                allOf(withId(R.id.textbox),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        autoCompleteTextView2.perform(replaceText("Carne"), closeSoftKeyboard());
        ...
        ViewInteraction autoCompleteTextView3 = onView(
                allOf(withId(R.id.textbox),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        autoCompleteTextView3.perform(replaceText("Pasta"), closeSoftKeyboard());
